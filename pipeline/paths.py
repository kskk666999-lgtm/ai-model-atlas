...
REGISTRY_CAPABILITIES = REGISTRY_DIR / "capabilities.yml"
REGISTRY_RELEASES = REGISTRY_DIR / "releases.yml"
...
MAPPING_COVERAGE_JSON = REPORTS_DIR / "mapping-coverage.json"
MAPPING_COVERAGE_MD = REPORTS_DIR / "mapping-coverage.md"

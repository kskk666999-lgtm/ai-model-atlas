...
| livebench-agentic-coding | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 61 | 61 | 49 | 80% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
...
| superclue-agent-planning | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| superclue-agentic-coding | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| superclue-general | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| superclue-hallucination-control | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
...
| superclue-math | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| superclue-precise-instruction | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| superclue-science-reasoning | superclue | 18 | 18 | 15 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
...
| terminalbench-4 | terminalbench | 27 | 15 | 9 | 60% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
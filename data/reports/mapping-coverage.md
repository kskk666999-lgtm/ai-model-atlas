...
| livebench-agentic-coding | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 58 | 58 | 49 | 84% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
...
| terminalbench-4 | terminalbench | 26 | 14 | 9 | 64% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
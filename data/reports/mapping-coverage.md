...
| livebench-agentic-coding | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 54 | 54 | 49 | 91% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |

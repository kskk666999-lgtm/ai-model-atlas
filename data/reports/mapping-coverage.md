...
| livebench-agentic-coding | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 55 | 55 | 49 | 89% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |

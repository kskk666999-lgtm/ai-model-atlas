...
| livebench-agentic-coding | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 56 | 56 | 49 | 88% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |

...
| livebench-agentic-coding | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 63 | 63 | 49 | 78% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |

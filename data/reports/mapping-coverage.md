...
| livebench-agentic-coding | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-coding | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-data-analysis | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-instruction-following | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-language | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-mathematics | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-input | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-price-output | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
| livebench-reasoning | livebench | 59 | 59 | 49 | 83% | ❌ | 未通过门槛（映射覆盖率/参评模型数不足） |
